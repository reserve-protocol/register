...
*Document type: LLM-generated reference for the Reserve AI Photonics DTF ($PHOTON). Document version 0.3 · Data as of June 2026. This is a living document and a template for the broader Reserve AI DTF suite (BUILDOUT, POWER, NEOCLOUD, ROBOTS). Verify everything on app.reserve.org before acting.*
