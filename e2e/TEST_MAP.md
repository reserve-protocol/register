...
| Wallet connection | [flows/wallet-connect](tests/flows/wallet-connect.spec.ts) | Legal footer; iframe-only Safe option absent outside Safe; connect → account → persistent disconnect; plain address (never clipped) and short/long ENS labels with header/navigation bounds at 360/412/1280px | none | yes | Real WalletConnect handoff and Safe iframe/relay sessions remain manual |
