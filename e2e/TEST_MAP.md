...
76 specs across 5 top-level dirs: `general/` (8), `index-dtf/` (19),
...
| Issuance – Zap | [issuance/zap-render](tests/index-dtf/issuance/zap-render.spec.ts), [issuance/compliance](tests/index-dtf/issuance/compliance.spec.ts), [flows/zap-buy-sell](tests/flows/zap-buy-sell.spec.ts), [flows/zap-edge](tests/flows/zap-edge.spec.ts), [flows/failures-zap](tests/flows/failures-zap.spec.ts), [issuance/ondo-market-closed](tests/index-dtf/issuance/ondo-market-closed.spec.ts) | widget+buy panel+direction flip render; geo-restriction gates trade surface; buy/sell full tx flow; high-impact warning+ack gate (impact pinned into the [5%, 8%) window; >8% is toxic-filtered); dead quote round = silent sourcing + recovery; insufficient-funds gating (quote resolves, submit disabled); reject/revert on buy and sell; closed-US-market pre-quote heads-up card (`/dtf/ondo` override) present when closed, absent when open | none | partial (render+compliance+ondo-closed) | — |
