...
- Transaction design is paused at a verified lab checkpoint, not promoted or
  adopted. Current Review retains its route for explicit later resumption.
  The five families are Zapper, Vote Lock / Unlock / Delegate, Stake / Unstake /
  Delegate, Automated Mint/Redeem, and the expanded Manual Mint/Redeem lifecycle.
  Their current local designs preserve the human-directed refinements; pausing
  does not undo those decisions or accept every visible specimen. Automated issuance
