...
- **Evidence:** f1-complete-detail-reference-caption-vs-capture-1400.png *(capture generated locally; not tracked)*, f1-complete-detail-reference-dark-390.png *(capture generated locally; not tracked)*.
...
- **Evidence:** f2-history-help-touch-first-tap-4ms.png *(capture generated locally; not tracked)* (open), f2-history-help-touch-first-tap-1500ms.png *(capture generated locally; not tracked)* (already closed), f2-history-help-touch-second-tap-1500ms.png *(capture generated locally; not tracked)* (second tap holds), f2-current-help-touch-first-tap-1500ms.png *(capture generated locally; not tracked)* (the current table’s help holds from the first tap).
...
- **Evidence:** f3-phone-help-open-390.png *(capture generated locally; not tracked)* → f3-phone-after-tapping-card-to-dismiss-390.png *(capture generated locally; not tracked)*.
...
- **Evidence:** f4-compact-auction-query-failed-390.png *(capture generated locally; not tracked)*, f4-compact-completed-390.png *(capture generated locally; not tracked)*, f4-detail-auction-query-failed-390.png *(capture generated locally; not tracked)*, and the dash beside the Completed status in the F1 desktop capture.
...
- **Evidence:** f5-desktop-live-two-countdowns-1400.png *(capture generated locally; not tracked)*.
...
- **R6 — Double focus indicator on links.** Proposer links show the semantic ring plus the browser’s default outline (`outline: auto 1px`) when focused via keyboard; the arrow and help buttons show the ring only. Cosmetic; belongs to the shared focus role, not this lab. Evidence: cov-desktop-hover-focus-1400.png *(capture generated locally; not tracked)*.
...
- **Q5** — es/ko/zh: only the approved labels are translated. “Proposed … by”, “Auction 1”, “Duration”, “Ends in”, “Bids”, the status words (Ongoing, Launching…, Loading, Unavailable, Completed, Expired) and all history labels stay English, and the compact date renders as “ago 3, 8:50pm” / “8월 3, 8:50오후”. Lab fixture scope, not a lab defect — but the migration must own these strings and the date pattern. Evidence: cov-locales-es-ko-zh-320.png *(capture generated locally; not tracked)*.
