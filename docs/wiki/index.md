...
- [[e2e]] — Playwright suite: offline mock architecture (wallet/rpc/subgraph/api), snapshot capture, smoke-vs-flows split, agent quick loop, phase plan (co-work doc with Codex)
