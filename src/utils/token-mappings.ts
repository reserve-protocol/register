...
export const NATIVE_TOKENS: Record<string, NativeToken> = {
  ...
  trx: {
    ...
    name: 'TRON',
    caip2: 'tron:mainnet',
    logo: 'https://assets.coingecko.com/coins/images/1094/large/TRON.png',
    coingeckoId: 'tron',
  },
  ada: {
    symbol: 'ADA',
  ...
  hype: {
    ...
    logo: 'https://assets.coingecko.com/coins/images/37504/large/hype.png',
...
export const BRIDGES: Record<string, Bridge> = {
  wormhole: {
    ...
    description: 'Cross-chain messaging protocol enabling token transfers across multiple blockchains',
  ...
  universal: {
    ...
    description: 'Asset-backed token platform with 1:1 backing and Coinbase Custody',
  ...
  native_wrap: {
    ...
    name: 'Native Wrapped',
    url: '',
    description: 'Native blockchain wrapped version (e.g., WBTC for BTC, WETH for ETH)',
    logo: '',
    risks: [
  ...
  bsc_bridge: {
    ...
    description: 'Binance Smart Chain official bridge for cross-chain asset transfers',
    logo: 'https://assets.coingecko.com/coins/images/825/large/bnb-icon2_2x.png',
    risks: [
...
export const BRIDGE_NATIVE_MAP: Record<number, Record<string, BridgedTokenMapping>> = {
  [ChainId.Base]: {
...
export function getNativeToken(
  chainId: number,
  tokenAddress: string
): { native: NativeToken; bridge: Bridge; mapping: BridgedTokenMapping } | null {
...
export function groupByNativeAsset(
  ...
  chainId: number
): Map<string, { native: NativeToken; tokens: Array<any>; totalWeight: number }> {
