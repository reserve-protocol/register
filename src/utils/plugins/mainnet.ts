...
const underlyingCollateralAddresses = {
  ...
  wcUSDCv3: '0xc3d688B66703497DAA19211EEdff47f25384cdc3',
...
const plugins: CollateralPlugin[] = [
  ...
  {
    symbol: 'wcUSDCv3',
    address: collateralAddresses.wcUSDCv3,
    decimals: 6,
    targetUnit: TARGET_UNITS.USD,
    referenceUnit: 'USDC',
    collateralToken: 'wcUSDCv3',
    description: '',
    depositContract: '0x45fd57EFd43f9Cf96859e38C15380A822C3c2352',
    collateralAddress: underlyingCollateralAddresses.wcUSDCv3,
    rewardToken: [COMPOUND_ADDRESS[ChainId.Mainnet]],
  },
  {
    symbol: 'stkcvx3Crv',
