...
const ProtocolStats = () => {
  ...
  const statInfo = [
    ...
    },
    {
      ...
      tooltip: t`The revenue generated by the protocol for RToken holders. Calculation based on the last 30 days revenue.`,
    },
    {
      icon: <LeafIcon />,
      ...
      tooltip: t`The revenue generated by the protocol for RSR stakers. Calculation based on the last 30 days revenue.`,
    },
  ]
