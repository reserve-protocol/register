...
const ProtocolStats = () => {
  ...
  const statInfo = [
    ...
    },
    {
      ...
      tooltip: t`The annual revenue generated by the protocol for RToken holders, calculated using the RToken holder APY and supply of the listed RTokens.`,
    },
    {
      icon: <LeafIcon />,
      ...
      tooltip: t`The annual revenue generated by the protocol for RSR stakers, calculated using the Staker APY and supply of the listed RTokens.`,
    },
  ]
