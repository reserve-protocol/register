...
const faqs = [
  {
    ...
    content: <Trans>When staking RSR, you are putting your RSR at risk in the case of a
    ...
    stakers proportionally to their stake in the pool.</Trans>,
  },
  {
    title: <Trans>Mechanics</Trans>,
    content: <Trans>When you stake your RSR, you will receive a stRSR receipt token which
  ...
  },
  {
    ...
    content: <Trans>When you unstake your stRSR, there will be a delay (defined by
      ...
      continually be incentivized to unstake and restake.</Trans>,
  },
  {
    title: <Trans>Risk evaluation</Trans>,
    content: <Trans>Please carefully evaluate the RToken before choosing to stake your RSR
    ...
    difference for RToken holders.</Trans>,
  },
]
