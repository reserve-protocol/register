...
export function CurrentMessages({
  ...
  const errors: Partial<Record<DataState, string>> = {
    ...
    'metadata-error':
      'Lab: token metadata is unavailable. Launch and weight editing are blocked.',
    'auction-error':
      'Lab: auction state is unknown. Launch stays blocked until it can be confirmed.',
    bounds:
      'Lab: a token is out of bounds. Launch stays blocked; closing the rebalance requires engineering review.',
