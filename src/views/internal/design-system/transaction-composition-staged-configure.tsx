        ...
        >
          ...
          >
            <h4 className={v1Typography.itemTitle}>
              {isMint ? (
                chain === ChainId.BSC ? (
                  <Trans>Enter USDT amount</Trans>
                ) : (
                  <Trans>Enter USDC amount</Trans>
                )
              ) : (
        ...
        >
          {isMint ? (
            <>
              <UpcomingStep
                number="2"
                title={<Trans>Automatically acquire assets</Trans>}
                detail={
                  chain === ChainId.BSC ? (
                    <Trans>
              ...
              <UpcomingStep
                number="3"
                title={<Trans>Mint CMC20</Trans>}
                detail={
                  <Trans>The acquired assets are used to mint your DTF.</Trans>
                }
              />
            </>
          ) : (
            <UpcomingStep
              number="2"
              title={<Trans>Automatically sell collateral</Trans>}
              detail={
                <Trans>
