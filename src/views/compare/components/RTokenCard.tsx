...
import CollateralPieChartWrapper from '@/views/rtoken/overview/components/CollateralPieChartWrapper'
import RTokenAddresses from '@/views/rtoken/overview/components/RTokenAddresses'
