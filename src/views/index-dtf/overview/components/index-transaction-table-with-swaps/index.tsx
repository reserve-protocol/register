...
import { indexDTFAtom, indexDTFPriceAtom, indexDTFTransactionsAtom } from "@/state/dtf/atoms";
...
const SwapsTransactionTable = () => {
  ...
  return (
    <Card className="group/section overflow-hidden pb-2 pt-5 sm:pb-3 sm:pt-6" id="transactions">
