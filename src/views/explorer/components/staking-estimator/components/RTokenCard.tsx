...
import EarnButton from 'views/compare/components/EarnButton'
import MobileCollateralInfo from 'views/compare/components/MobileCollateralInfo'
import VerticalDivider from 'views/compare/components/VerticalDivider'
import usePriceETH from 'views/compare/hooks/usePriceETH'
