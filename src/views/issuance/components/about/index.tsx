...
const About = () => (
  <Box sx={{ border: '1px solid #ccc', borderRadius: '16px' }} p={4}>
    <Text>
      ...
      lobortis.
      <br /> <br />
      Pharetra diam sit amet nisl. Quis hendrerit dolor magna eget est lorem
      ipsum dolor. Habitasse platea dictumst vestibulum rhoncus est libero
      volutpat sed cras ornare arcu. Varius quam quisque id diam.
    </Text>
  </Box>
)
