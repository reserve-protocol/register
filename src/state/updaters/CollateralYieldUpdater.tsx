...
const poolsMap: Record<number, Record<string, string>> = {
  [ChainId.Mainnet]: {
    ...
    '931ea9be-5f4d-428e-beaf-205fc5b4e2b5': 'steakusdcprime',
    'ef5d3acb-b974-4db1-8076-e8db9f142493': 'steakusdt',
    '699f25fe-09f4-4f82-8f58-baa5b0af8fa4': 'senpyusdmain',
    'ff113246-f6e0-4e10-b92c-abd3cd1d7dd6': 'gtusdcf',
    '71b34441-5a46-431b-a9b3-8c081cd0d74c': 'gtusdcp',
    'ba8f47b8-2cc2-4976-a0f9-1bd8da4bcb91': 'gusdcq',
    '09946099-2c68-4fcb-bc6c-32b6bf6019fe': 'gusdtq',
    '89641d1d-6ee2-431b-b131-a0b49c59e2c5': 'skymoneyusdtsavings',
  },
  [ChainId.Base]: {
