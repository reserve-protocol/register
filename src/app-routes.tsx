...
import IndexDTFAdminProposal from './views/index-dtf/governance/views/propose/folio'
...
const AppRoutes = () => (
  <Routes>
    ...
    <Route path={`/:chain/index-dtf/:tokenId`} element={<IndexDTFContainer />}>
      ...
      />
      <Route
        path={`${ROUTES.GOVERNANCE}/${ROUTES.GOVERNANCE_PROPOSE}/${GOVERNANCE_PROPOSAL_TYPES.ADMIN}`}
        element={<IndexDTFAdminProposal />}
      />
      <Route
        path={`${ROUTES.GOVERNANCE_PROPOSAL}/:proposalId`}
