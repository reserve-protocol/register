...
const oracles = [
  {
    ...
    "slotIndex": 44,
    "slotData": "0x0000000064c844d7000000000000000000000000000000000000000005f5d2f0",
  ...
  },
  {
    ...
    "slotIndex": 43,
    "slotData": "0x0000000064c844dc000000000000000000000000000000000000000005f5d41c",
  ...
  },
  {
    ...
    "oraclePrice": 1,
    "slotIndex": 43,
    "slotData": "0x0000000064c844e0000000000000000000000000000000000000000005f5e100",
  ...
  },
  {
    ...
    "slotIndex": 43,
    "slotData": "0x0000000064c844e4000000000000000000000000000000000000000005f62944",
  ...
  },
  {
    ...
    "slotIndex": 43,
    "slotData": "0x0000000064c844e9000000000000000000000000000000000000000005f4dcb8",
  ...
  },
  {
    ...
    "slotIndex": 44,
    "slotData": "0x0000000064c844ee000000000000000000000000000000000000000005f50c80",
  ...
  },
  {
    ...
    "slotIndex": 43,
    "slotData": "0x0000000064c844f2000000000000000000000000000000000000000005f50404",
  ...
  },
  {
    ...
    "oraclePrice": 1,
    "slotIndex": 44,
    "slotData": "0x0000000064c844f7000000000000000000000000000000000000000005f5e100",
  ...
  },
  {
    ...
    "oraclePrice": 1,
    "slotIndex": 44,
    "slotData": "0x0000000064c844fc000000000000000000000000000000000000000005f5e100",
  ...
  },
  {
    ...
    "oraclePrice": 1870,
    "slotIndex": 44,
    "slotData": "0x0000000064c84501000000000000000000000000000000000000002b8a118e00",
  ...
  },
  {
    ...
    "oraclePrice": 30000,
    "slotIndex": 44,
    "slotData": "0x0000000064c8450600000000000000000000000000000000000002ba7def3000",
  ...
  },
  {
    ...
    "slotIndex": 44,
    "slotData": "0x0000000064c8450a000000000000000000000000000000000000000006919b35",
  ...
  },
  {
    ...
    "oraclePrice": 1.0894,
    "slotIndex": 43,
    "slotData": "0x0000000064c8450f0000000000000000000000000000000000000000067e4ae0",
  ...
  },
  {
    ...
    "oraclePrice": 1,
    "slotIndex": 44,
    "slotData": "0x0000000064c84514000000000000000000000000000000000de0b6b3a7640000",
  ...
  },
  {
    ...
    "oraclePrice": 1870,
    "slotIndex": 44,
    "slotData": "0x0000000064c84519000000000000000000000000000000000000002b8a118e00",
  ...
  },
  {
    ...
    "oraclePrice": 1.0752,
    "slotIndex": 44,
    "slotData": "0x0000000064c8451e000000000000000000000000000000000eebe0b40e7fffbe",
  ...
  },
  {
    ...
    "slotIndex": 44,
    "slotData": "0x0000000064c84523000000000000000000000000000000000e6c8cbe32ec6a44",
  ...
  },
  {
    ...
    "slotIndex": 44,
    "slotData": "0x0000000064c84528000000000000000000000000000000000000000005f448cc",
...
const oraclesToLoad = [] as string[]
  ...
  ; (window as never as any).__reserveDevTools = async (
    ...
    const data = await Promise.all(
      oraclesToLoad.map(async (oracle) => {
        const oracleContract = new ethers.Contract(oracle, OracleAbi, provider)
        const [priceBN, aggregator, decimals, name] = await Promise.all([
        ...
        oracleInst.slot = (async () => {
          ...
          let slotId = 43
          let slotData = constants.HashZero
          let key = ""
          for (let i = 0; i < 10; i++) {
            const transmissionsSlot = hexZeroPad(hexValue(slotId), 32)
            const nthTransmission = hexZeroPad((await roundId)!.toHexString(), 32)

            key = solidityKeccak256(
              ['uint256', 'uint256'],
              [nthTransmission, transmissionsSlot]
            )
            slotData = await provider.getStorageAt(oracleInst.aggregator, key)
            if (slotData !== ethers.constants.HashZero) {
              slotData = slotData
              break
            }
            slotId += 1
    ...
    data.push(
      ...(await Promise.all(
        oracles.map(async oracle => {
          ...
          const roundId = await aggregatorOracle.callStatic
            .latestRound({ from: oracle.chainLinkFeed })
            .catch(() => null)
          ...
          return {
            ...
            slot: Promise.resolve({
              slotIndex: oracle.slotIndex,
              slotData: oracle.slotData,
              key: oracle.key,
              roundId,
            })
          }
    ...
    const updateOracleData = async (
      ...
      const newEntry = hexConcat([
        hexZeroPad('0x' + Math.floor(Date.now() / 1000).toString(16), 8),
        hexZeroPad(
          parseUnits(
            parseFloat(newPrice).toFixed(oracle.oracleDecimals),
      ...
      if (slot.slotData === newEntry) {
        return
      }

      await provider.send('tenderly_setStorageAt', [oracle.aggregator, slot.key, newEntry])

      const latestPrice = await oracleContract.callStatic
        .latestAnswer()
        .catch(() => null)
      oracle.oraclePrice =
        latestPrice == null
          ? 0
          : parseFloat(formatUnits(latestPrice, oracle.oracleDecimals))
        ...
        await Promise.all(
          plugins.map(async (plug) => {
            ...
            const [price, status] = await Promise.all([
              assetContract.callStatic.price().catch(() => [0n, 0n]),
    ...
    printState()
    return {
      refreshPluginState: async () => {
        Object.assign(pluginState, await loadPluginState())
        printState()
      },
      printState,
      dumpState: () => {
        console.log(JSON.stringify(data.map(({ slot, ...oracle }) => ({
          ...oracle,
        }))))
      },
      plugins: pluginState,
      ...
      makeAllPricesRecent: () => Promise.all(
        data.map(oracle => updateOracleData(
          oracle,
          oracle.oraclePrice.toFixed(oracle.oracleDecimals),
        ))
      )
    }
  }
