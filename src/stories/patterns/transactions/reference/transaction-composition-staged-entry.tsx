      ...
      >
        ...
        >
          <p className={v1Typography.label}>
            <>Before using automated minting</>
          </p>
          <p
            className={cn(
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <IconButton
            label={`Back to automated minting introduction`}
            icon={<ArrowLeft />}
            size="compact"
        ...
        >
          ...
          >
            ...
            <div className="mt-3 flex items-center gap-2">
              <SupportedWallet
                ...
                label={`Open MetaMask website`}
              />
              <SupportedWallet
                href="https://www.ambire.com/"
                image="/svgs/Ambire.svg"
                label={`Open Ambire website`}
              />
              <SupportedWallet
                href="https://safe.global/"
                image="/svgs/Safe.svg"
                label={`Open Safe website`}
              />
            </div>
            <p
              className={cn(
          ...
          >
            <Button onClick={() => setState('Initial configuration')}>
              {incompatible ? <>Switch wallet</> : <>Connect Wallet</>}
            </Button>
