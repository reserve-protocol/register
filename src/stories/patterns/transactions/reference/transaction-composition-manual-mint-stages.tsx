...
export const ManualMintStages = ({
  ...
  const approvalStatus = canShowReadiness
    ? `${approved} of ${total} tokens approved`
    : `Token approvals`
    ...
    <div className="-mx-2 flex flex-col">
      ...
      >
        ...
        >
          <TransactionAmountObject
            ...
            amount={canShowReadiness ? `${approved} of ${total}` : '—'}
            readOnly
            presentation="output"
            className={
              ...
              >
                {approvalsReady ? (
                  ...
                  <>
                    ...
                    <HelpTooltip
                      accessibleLabel={`About token approvals`}
                      content={
                        <>
      ...
      >
        ...
        >
          ...
          >
            <>Your basket tokens will be exchanged for CMC20.</>
          </p>
        </div>
        <div className="pt-2">
          <ManualIssuanceAction
