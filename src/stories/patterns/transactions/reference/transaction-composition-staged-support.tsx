...
const ORDER_STATUS_LABELS: Record<AutomatedMintOrderStatus, string> = {
      ...
      {quoteUnavailable ? (
        ...
        >
          ...
          >
            ...
            />
            <OrderAmount
              label={order.boughtIsEstimate ? <>Sell quote</> : <>Sold</>}
          ...
          >
            <OrderAmount
              align="right"
              label={order.boughtIsEstimate ? <>Buy quote</> : <>Bought</>}
              ...
              >
                ...
                >
                  ...
                  <span className="sr-only">
                    {`Opens CoW Explorer in a new tab`}
                  </span>
                </a>
              </Button>
            </div>
...
export const AutomatedMintExplorerButton = ({
  ...
  const externalAnnouncement =
    chain === ChainId.BSC
      ? `Opens BscScan in a new tab`
      : `Opens Basescan in a new tab`
  ...
  return (
    ...
    >
      <a
        aria-label={`${`View transaction`}, ${externalAnnouncement}`}
