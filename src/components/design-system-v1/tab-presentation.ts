...
export const tabPresentationRecipe = {
  textOnly: {
    compact: {
      list: 'flex h-8 items-center justify-start gap-4 rounded-none bg-transparent p-0',
      item: 'h-8 rounded-none bg-transparent p-0 text-sm font-light',
    },
    default: {
      list: 'flex h-11 items-center justify-start gap-5 rounded-none bg-transparent p-0',
