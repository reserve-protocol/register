...
import type { RevenueTrader, RevenueTraderInterface } from "../RevenueTrader";
...
export class RevenueTrader__factory {
  ...
  static createInterface(): RevenueTraderInterface {
    return new utils.Interface(_abi) as RevenueTraderInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): RevenueTrader {
    return new Contract(address, _abi, signerOrProvider) as RevenueTrader;
  }
}
