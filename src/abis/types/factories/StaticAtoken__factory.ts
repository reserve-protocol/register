...
import type { StaticAtoken, StaticAtokenInterface } from "../StaticAtoken";
...
export class StaticAtoken__factory {
  ...
  static createInterface(): StaticAtokenInterface {
    return new utils.Interface(_abi) as StaticAtokenInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): StaticAtoken {
    return new Contract(address, _abi, signerOrProvider) as StaticAtoken;
  }
}
