...
export type ProposalsClearedEvent = TypedEvent<[], {}>;
...
export type VaultChangedEvent = TypedEvent<
  [string, string],
  { oldVaultAddr: string; newVaultAddr: string }
>;
...
export type WeightsProposedEvent = TypedEvent<
  ...
  { id: BigNumber; proposer: string; tokens: string[]; weights: BigNumber[] }
>;
...
export type ProposalCanceledEvent = TypedEvent<
  ...
  { id: BigNumber; proposer: string; canceler: string }
>;
...
export type NewOwnerNominatedEvent = TypedEvent<
  [string, string],
  { previousOwner: string; nominee: string }
>;
