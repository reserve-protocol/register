...
export interface StaticAtokenInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    functionFragment: "METADEPOSIT_TYPEHASH",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "METAWITHDRAWAL_TYPEHASH",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "STATIC_ATOKEN_LM_REVISION",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface StaticAtoken extends BaseContract {
