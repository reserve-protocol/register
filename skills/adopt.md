...
5. **Verify.** `node scripts/ai-loop/wiki-lint.mjs` green; `scope.mjs --base HEAD --dry-run` maps sensible commands; every inventoried rule is findable in its new home or named in the drop log.
